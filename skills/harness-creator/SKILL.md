...
Identify the lowest-scoring subsystem as the highest-priority improvement area. Treat it as a candidate bottleneck, then confirm with failure logs, verification evidence, and task outcomes before calling it the bottleneck.
